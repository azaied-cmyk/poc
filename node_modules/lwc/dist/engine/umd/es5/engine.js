(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function htmlPropertyToAttribute(propName) {
        ...
        var attributeName = '';
        for (var i_1 = 0, len = propName.length; i_1 < len; i_1++) {
            var code = StringCharCodeAt.call(propName, i_1);
            if (code >= 65 && // "A"
                code <= 90 // "Z"
            ) {
    ...
    var _f = Array.prototype, ArrayIndexOf$1 = _f.indexOf, ArrayJoin$1 = _f.join, ArrayMap$1 = _f.map, ArrayPush$1 = _f.push, ArraySlice$2 = _f.slice, ArrayUnshift$2 = _f.unshift, forEach$1 = _f.forEach;
    ...
    */
    ...
    function flattenStylesheets(stylesheets) {
        ...
        for (var _i = 0, stylesheets_1 = stylesheets; _i < stylesheets_1.length; _i++) {
            ...
            if (!Array.isArray(stylesheet)) {
                ...
                list.push.apply(list, flattenStylesheets(stylesheet));
            }
        }
        return list;
    }
    ...
    function removeActiveVM(vm) {
        ...
        if (runtimeFlags.ENABLE_HMR) {
            ...
            var Ctor = vm.def.ctor;
            var list_1 = activeComponents.get(Ctor);
            if (!isUndefined$1(list_1)) {
                // deleting the vm from the set to avoid leaking memory
                list_1.delete(vm);
            } // removing inactive template
            var tpl = vm.cmpTemplate;
            if (tpl) {
                list_1 = activeTemplates.get(tpl);
                if (!isUndefined$1(list_1)) {
                    // deleting the vm from the set to avoid leaking memory
                    list_1.delete(vm);
    ...
    function forceRehydration(vm) {
        ...
        vm.cmpTemplate = function () { return []; };
        if (isFalse$1$1(vm.isDirty)) {
