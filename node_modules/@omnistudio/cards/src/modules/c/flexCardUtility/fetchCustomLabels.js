 ...
 * Build: v234.0.0
 */
import { getCustomLabels } from "c/flexCardUtils";
...
let fetchUserLanguage = function() {
  return new Promise(function(resolve) {
    locale = locale || sessionStorage.getItem("userLocale");
...
let getCustomLabel = function(pendingLabel, lang) {
  return getCustomLabels({ labelNames: pendingLabel, language: lang });
};
