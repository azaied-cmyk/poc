 ...
 * Build: v234.0.0
 */
import { handleData } from "c/salesforceUtils";
import {
  BASE_URL,
  InputType,
  OutputType,
...
export class GooglePlacesService {
   ...
   * @param {string} location - The point around which you wish to retrieve place information. Must be specified as latitude,longitude. @see {@link module:c/utility#getCoordinates}
  ...
  placeAutocomplete(
    ...
    let url = `${this.endpoints.placeAutocomplete}&input=${query}&sessiontoken=${sessionToken}&types=${types}`;
...
// This method has been copied from `c/utility/dataHandler.js`
