...
export default class VlocityInput extends LightningElement {
  ...
  @api get validationMessage() {
    return this.template.querySelector("input").validationMessage;
  }
  @api fieldLevelHelp;
  ...
  initOptions() {
    ...
    switch (this.type) {
      ...
      case "date":
        ...
        this._innerElement = "c-date-picker";
        break;
      case "time":
        this.isTime = true;
        this.isCustomLwc = true;
        this._innerElement = "c-time-picker";
        break;
      case "datetime":
        this.isCustomLwc = true;
    ...
    if (!this.isNumber && this.mask && this.maskRange && this.maskPlaceholder) {
      ...
      setTimeout(() => {
        if (
          ...
          target.selectionStart = target.selectionEnd = this.inputValue.indexOf(
            "_"
          );
      });
    }
  ...
  validateError(event) {
    if (event && this.isNumber && !this.ignoreMask) {
