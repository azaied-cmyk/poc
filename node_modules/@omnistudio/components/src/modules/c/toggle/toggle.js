...
import { lwcPropertyNameConversion, interpolateWithRegex } from "c/utility";
...
export default class VlocityCheckboxGroup extends CheckboxGroup {
  ...
  set required(val) {
    ...
    this._required = this._requiredValue === "true" || this._requiredValue === true ;
  }
  ...
  setValue(type) {
    if (
      ...
      if (this.Type.isStatefulBtn) {
        ...
        if (type === "init") {
          if(!this._element.classList.contains(`${this.theme}-is-selected-clicked`)){
