<template>
  <c-layout extraclass="slds-gutters" data-loading-table={updatingTable}>
    <template if:true={issearchavailable}>
      <c-layout-item class="slds-m-bottom_large" size="11">
        <c-input
  ...
  <div class="slds-is-relative slds-scrollable_x" aria-live="polite">
    ...
    <div role="table" class={tableClass} style="border-collapse:collapse;width: 100%;">
      <div role="rowgroup" if:false={hideTableHeader} class="slds-data-table-head">
        <div role="row" class="slds-line-height_reset slds-data-table-row">
          ...
          <template if:false={isGrouped}>
            <div role="columnheader"
              ...
              class="slds-data-table-head-cell slds-icon-width"
            ></div>
            <div role="columnheader" if:true={_userSelectableRow} class="slds-data-table-head-cell">
              <label
