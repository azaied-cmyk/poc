<template>
  <c-layout extraclass="nds-gutters" data-loading-table={updatingTable}>
    <template if:true={issearchavailable}>
      <c-layout-item class="nds-m-bottom_large" size="11">
        <c-input
  ...
  <div class="nds-is-relative nds-scrollable_x" aria-live="polite">
    ...
    <div role="table" class={tableClass} style="border-collapse:collapse;width: 100%;">
      <div role="rowgroup" if:false={hideTableHeader} class="nds-data-table-head">
        <div role="row" class="nds-line-height_reset nds-data-table-row">
          ...
          >
            ...
            >
              <label class="nds-checkbox" title="Select Row">
                <input
                  type="checkbox"
          ...
          <template if:false={isGrouped}>
            <div
              ...
              class="nds-data-table-head-cell nds-icon-width"
            ></div>
            <div role="columnheader" if:true={_userSelectableRow} class="nds-data-table-head-cell">
              <label class="nds-checkbox nds-p-left_x-small" title="Select Row">
                <input
                  type="checkbox"
                  onchange={handleSelectAllRow}
                  checked={selectAllRow}
      ...
      <div role="rowgroup" ondrop={onDrop} class="nds-data-table-body">
        ...
        >
          ...
          >
            ...
            <template
              ...
              if:true={baseVersion}
            >
              <div role="cell" key={cell.id} class="nds-data-table-row-cell">
                <c-data-table-cell
        ...
        <template
          ...
          if:true={isGrouped}
        >
          <div role="row" key={group.id} class={group.displayClass}>
            <div role="cell" class="nds-data-table-row-cell">
              <button
