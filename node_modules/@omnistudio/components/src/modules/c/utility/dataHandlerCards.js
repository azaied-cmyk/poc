 ...
 * Build: v234.0.0
 */
import { handleDataCards } from "c/salesforceUtils";
import { getDatahandlerOut, isSalesforcePlatform } from "c/sdkUtility";

function getCardsDataHandler(requestData) {
...
function handleOptions(requestData, res) {
  ...
  if (
    ...
    return processedResp.result.then(vlcParams => {
      ...
      return getCardsDataHandler(JSON.stringify(reqData));
    });
  }
  return res;
}
...
export default getCardsDataHandler;
