...
/**
 *
 * Method to fetch the community page url prefix
 * @return {String}
 */
const getCommunityPrefix = () => {
...
const setVlocityAction = (action, disableCache) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    getActions(disableCache).then(allActions => {
      ...
      if (selectedAction) {
        ...
        let clonedAction = {
          ...
          optionsMap: action[namespace + "InvokeClassName__c"]
            ? action.optionsMap
            : "",
          hasExtraParams: action.hasExtraParams ? action.hasExtraParams : false,
        ...
        if (clonedAction.Attachments && clonedAction.Attachments.length > 0) {
          clonedAction.imageRef =
            (isCommunity ? getCommunityPrefix() : window.location.origin) +
