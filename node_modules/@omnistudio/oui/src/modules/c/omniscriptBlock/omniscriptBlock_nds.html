  ...
  <div class="nds-size_1-of-1">
    <div class={blockClasses}>
      <div class="nds-form-element__control nds-block_container">
        ...
        <label class="nds-form-element__label nds-clearfix">
          <template if:true={_propSetMap.repeat}>
            <button if:true={blockLabel}
              ...
              <c-icon extraclass="nds-block__action-icon nds-button__icon nds-button__icon-left"
        ...
        <template if:true={_propSetMap.repeat}>
          <div class="nds-is-absolute nds-button-group"
               role="group">
            <c-button if:true={canRepeat}
                      variant="base"
                      onclick={handleAdd}
