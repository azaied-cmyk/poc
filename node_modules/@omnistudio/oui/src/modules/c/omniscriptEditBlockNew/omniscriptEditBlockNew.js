...
import tmpl from './omniscriptEditBlockNew.html';
...
export default class OmniscriptEditBlockNew extends LightningElement {
    ...
    handleAdd() {
        if (this._isCards && this.scriptHeaderDef && this.scriptHeaderDef.uuid) {
            pubsub.fire(this._jsonDef.name + '_' + this.scriptHeaderDef.uuid, 'data', { add: true, addIndex: this.jsonDef.eleArray.length - 1 });
        }
    }
