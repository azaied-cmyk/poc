 ...
 * Build: v234.0.0
 */
import { CustomLabels } from 'c/omniscriptRestApi';
import { namespace } from 'c/namespaceUtils';
import { mergeWith } from 'c/lodash';
...
export const ootbLabelMap = {
    'Calculation Action': ['failureNextLabel', 'failureGoBackLabel', 'inProgressMessage', 'errorMessage:custom|n:message', 'errorMessage:default'],
    ...
    'Delete Action': ['failureNextLabel', 'failureGoBackLabel', 'inProgressMessage', 'remoteConfirmMsg', 'cancelLabel', 'subLabel'],
    ...
    'Email Action': ['failureNextLabel', 'failureGoBackLabel', 'inProgressMessage', 'errorMessage:custom|n:message', 'errorMessage:default'],
    ...
    'Matrix Action': ['failureNextLabel', 'failureGoBackLabel', 'inProgressMessage', 'errorMessage:custom|n:message', 'errorMessage:default'],
    'PDF Action': [
        'failureNextLabel',
        'failureGoBackLabel',
        'inProgressMessage',
    ...
    'Post to Object Action': ['failureNextLabel', 'failureGoBackLabel', 'inProgressMessage', 'errorMessage:custom|n:message', 'errorMessage:default'],
    'Remote Action': ['failureNextLabel', 'failureGoBackLabel', 'inProgressMessage', 'errorMessage:custom|n:message', 'errorMessage:default'],
    'Rest Action': ['failureNextLabel', 'failureGoBackLabel', 'inProgressMessage', 'errorMessage:custom|n:message', 'errorMessage:default'],
    ...
    Range: ['helpText'],
    Script: ['persistentComponent|n:label', 'consoleTabTitle', 'errorMessage:custom|n:message'],
...
export const ootbLabelMapOld = {
    ...
    'Calculation Action': ['failureAbortLabel', 'failureAbortMessage', 'redirectNextLabel', 'redirectPreviousLabel'],
    'DataRaptor Extract Action': ['failureAbortLabel', 'failureAbortMessage', 'redirectNextLabel', 'redirectPreviousLabel'],
    'DataRaptor Post Action': ['failureAbortLabel', 'failureAbortMessage', 'redirectNextLabel', 'redirectPreviousLabel'],
    'DataRaptor Transform Action': ['failureAbortLabel', 'failureAbortMessage', 'redirectNextLabel', 'redirectPreviousLabel'],
    'Delete Action': ['failureAbortLabel', 'failureAbortMessage', 'redirectNextLabel', 'redirectPreviousLabel'],
    'DocuSign Envelope Action': ['failureAbortLabel', 'failureAbortMessage', 'redirectNextLabel', 'redirectPreviousLabel'],
    'DocuSign Signature Action': ['failureAbortLabel', 'failureAbortMessage', 'redirectNextLabel', 'redirectPreviousLabel'],
    'Email Action': ['failureAbortLabel', 'failureAbortMessage', 'redirectNextLabel', 'redirectPreviousLabel'],
    'Integration Procedure Action': ['failureAbortLabel', 'failureAbortMessage', 'redirectNextLabel', 'redirectPreviousLabel'],
    'Matrix Action': ['failureAbortLabel', 'failureAbortMessage', 'redirectNextLabel', 'redirectPreviousLabel'],
    'PDF Action': ['failureAbortLabel', 'failureAbortMessage', 'redirectNextLabel', 'redirectPreviousLabel'],
    'Post to Object Action': ['failureAbortLabel', 'failureAbortMessage', 'redirectNextLabel', 'redirectPreviousLabel'],
    'Remote Action': ['failureAbortLabel', 'failureAbortMessage', 'redirectNextLabel', 'redirectPreviousLabel'],
    'Rest Action': ['failureAbortLabel', 'failureAbortMessage', 'redirectNextLabel', 'redirectPreviousLabel'],
};
