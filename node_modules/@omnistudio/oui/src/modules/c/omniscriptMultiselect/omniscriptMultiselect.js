...
import tmpl from './omniscriptMultiselect.html';
 ...
 */
export default class OmniscriptMultiselect extends OmniscriptOptionsMixin(OmniscriptAtomicElement) {
    /**
    ...
    updatePropOptions(newOptions) {
        this.dispatchOmniEventUtil(
            this,
            { path: this._jsonPath + ':propSetMap', elementId: this._elementId, value: newOptions, node: 'options' },
            'omniupdatejsondef',
        );
    }
