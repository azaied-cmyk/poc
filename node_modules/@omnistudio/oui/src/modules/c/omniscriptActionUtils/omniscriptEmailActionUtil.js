...
export class OmniscriptEmailActionUtil extends OmniscriptBaseActionUtil {
    preProcess(params, queueableRespId, comp, payload, vlcParams) {
        ...
        let tempStr = JSON.stringify(this.stringifyProp(control.propSetMap.emailTemplateInformation.emailTemplateName));
        ...
        tempStr = JSON.stringify(this.stringifyProp(control.propSetMap.emailTemplateInformation.emailTargetObjectId));
        ...
        tempStr = JSON.stringify(this.stringifyProp(control.propSetMap.emailTemplateInformation.whatId));
        ...
        tempStr = JSON.stringify(this.stringifyProp(control.propSetMap.emailInformation.toAddressList));
        ...
        tempStr = JSON.stringify(this.stringifyProp(control.propSetMap.OrgWideEmailAddress));
        ...
        if (
            ...
            (control.propSetMap.remoteOptions.emailTemplateName === '' || control.propSetMap.remoteOptions.emailTemplateName === undefined)
        ) {
            return {
                error: true,
        ...
        tempStr = JSON.stringify(this.stringifyProp(control.propSetMap.emailInformation.ccAddressList));
        ...
        tempStr = JSON.stringify(this.stringifyProp(control.propSetMap.emailInformation.bccAddressList));
        ...
        tempStr = JSON.stringify(this.stringifyProp(control.propSetMap.emailInformation.emailSubject));
        ...
        tempStr = JSON.stringify(this.stringifyProp(control.propSetMap.emailInformation.emailBody));
        ...
        tempStr = JSON.stringify(this.stringifyProp(control.propSetMap.fileAttachments));
        ...
        if (control.propSetMap.attachmentList !== undefined) {
            tempStr = JSON.stringify(this.stringifyProp({ osAttList: control.propSetMap.attachmentList }));
            ...
            if (osAtt.osAttList && !Array.isArray(osAtt.osAttList)) osAtt.osAttList = [osAtt.osAttList];

            if (Array.isArray(osAtt.osAttList)) control.propSetMap.remoteOptions.osAttList = osAtt.osAttList;
        }
        ...
        if (control.propSetMap.contentVersionList !== undefined) {
            tempStr = JSON.stringify(this.stringifyProp({ osContVerList: control.propSetMap.contentVersionList }));
            ...
            if (osConVer.osContVerList && !Array.isArray(osConVer.osContVerList)) osConVer.osContVerList = [osConVer.osContVerList];
                    ...
                    for (let j = 0; j < addresses[i].length; j++) {
                        if (typeof addresses[i][j] === 'object') {
                            for (let addr in addresses[i][j]) {
                                if (addresses[i][j][addr]) addrArray.push(addresses[i][j][addr]);
                            }
