...
export class OmniscriptDocusignEnvelopeActionUtil extends OmniscriptBaseActionUtil {
    ...
    createDataRaptorPromise(control, input, comp) {
        ...
        propSetMap.remoteOptions.docuSignTemplatesGroup.forEach(docSignTemplateGroup => {
            ...
            if (transform != null && transform !== '') {
                ...
                const promise = drTransform.executeAction(null, null, comp, null, null).then(response => {
                    ...
                    if (resp && resp.error) {
                        comp.sendErrorModalUtil(resp.errorMsg, comp._isBtn, this._element, comp.scriptHeaderDef, comp);
                    } else {
                ...
                if (docSignTemplateGroup.sendJSONPath && docSignTemplateGroup.sendJSONPath !== '') {
                    ...
                    docSignTemplateGroup.input = applyDateFormat(docSignTemplateGroup.input, options);
                } else {
    ...
    getDataFromDocusignTemplate(control, comp) {
        ...
        if (control.propSetMap.docuSignTemplate && control.propSetMap.docuSignTemplate !== '') {
            ...
            docuSignInput.signerList = this.getDataFromMergeField(signerListStr, comp);
            ...
            for (let i = 0; i < control.propSetMap.docuSignTemplatesGroup.length; i++) {
                signerListStr = JSON.stringify(control.propSetMap.docuSignTemplatesGroup[i].signerList);
                let docuInp = {};
                ...
                control.propSetMap.remoteOptions.docuSignTemplatesGroup[i].docuSignTemplate =
                ...
                control.propSetMap.remoteOptions.docuSignTemplatesGroup[i].transformBundle =
    ...
    validateSigner(docuSignInput) {
        let i = 0;
        for (i; i < docuSignInput.signerList.length || docuSignInput.signerList.length === 0; i++) {
            if (
