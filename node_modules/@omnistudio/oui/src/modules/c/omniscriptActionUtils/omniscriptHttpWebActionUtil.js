...
import { sendRequest } from 'c/omniscriptInternalUtils';
...
export class OmniscriptHttpWebActionUtil extends OmniscriptBaseActionUtil {
    ...
    preProcess(params, queueableRespId, comp, payload, vlcParams) {
        const remoteOptions = getHttpRemoteOptions(comp, this._element, this.getCompJsonData(comp));
        params = {
            ...
            headers:
                typeof remoteOptions.restOptions.headers === 'object' && Object.keys(remoteOptions.restOptions.headers).length > 0
            ...
            withCredentials:
                this._element.propSetMap.restOptions && this._element.propSetMap.restOptions.withCredentials != null
