...
export class OmniscriptHttpSoapNcApexActionUtil extends OmniscriptBaseActionUtil {
    ...
    preProcess(params, queueableRespId, comp, payload, vlcParams) {
        const httpParams = {
            ...
            remoteOptions: getHttpRemoteOptions(comp, this._element, this.getCompJsonData(comp)),
        };
        ...
        return this.preProcessCommonReq(comp, this._element, httpParams, input, vlcParams);
    }
    ...
    evaluateResp(element, resp, bSendToDebugConsole, comp) {
        ...
        if (httpResp && typeof httpResp !== 'object') {
            try {
                ...
                httpResp = {
                    error: comp.scriptHeaderDef.allCustomLabels ? comp.scriptHeaderDef.allCustomLabels.OmniDesInvalidJson : 'OmniDesInvalidJson',
                };
            }
        }
