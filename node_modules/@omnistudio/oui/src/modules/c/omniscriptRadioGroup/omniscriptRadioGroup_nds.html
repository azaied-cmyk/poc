    ...
    <fieldset class="nds-form-element nds-form-container nds-m-top_small">
        ...
        <div class="nds-grid">
          ...
          <div class={_optionClass}>
            <template for:each={_propSetMap.options}
              ...
              <label class="nds-form-element__label vlc-setall__label"
                     key={radioButton.name}>
                <strong>
                  <span class="nds-listbox__option"
          ...
          <div class="nds-grid nds-p-bottom_small"
            ...
            <div class={_optionClass}>
              <template for:each={radioGroupLabel.options}
                        for:item="radioButton"
                        for:index="radioButtonIndex">
                <label class="nds-radio vlc-radiogroup__button"
                       key={radioButton.name}>
                  <input type="radio"
      ...
      <div class="nds-has-error nds-m-top_none">
        <div if:true={hasError}
             class="nds-form-element__help nds-form-element__help_text-transform__none">{errorMessage}
        </div>
      </div>
    </fieldset>
  </slot>
