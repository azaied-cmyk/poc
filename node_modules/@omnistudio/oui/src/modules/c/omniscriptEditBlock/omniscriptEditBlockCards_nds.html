    ...
    <div class="nds-grid nds-wrap nds-element_text-font">
      ...
      <template if:true={_isCards}>
        <div class={visualClass}
             ...
             role="application">
          <div class="nds-box nds-box_x-small nds-grid nds-grid_vertical nds-grid_vertical-align-center nds-is-relative nds-size_12-of-12 nds-m-right_medium nds-m-bottom_medium nds-edit-block_shortcards"
            ...
            <div class="nds-edit-block_shortcards-circle">
              <span class="nds-icon_container nds-icon_container_circle slds-current-color omni-icon-circle"
                    style="color: #1564bf;">
                <c-icon class=""
            ...
            <template if:true={_showCheckbox}>
              <span class="nds-is-absolute slds-icon_container nds-icon_container--circle"
      ...
      <template if:true={_isLongCards}>
        <div class={visualClass}
             onclick={handleCheckbox}>
          <div class="nds-grid nds-grid_align-center nds-is-relative nds-size_12-of-12 nds-m-right_medium nds-m-bottom_medium nds-grid_vertical-align-center nds-edit-block_longcards"
            ...
            <!-- Display Text -->
            <div class="nds-grid nds-grid_vertical nds-grid_align-center nds-p-left_small nds-max-small-size_5-of-12 nds-small-size_8-of-12"
                 id="longcard-text">
              <template for:each={_displayValues}
                        for:item='dvItem'
                        for:index='dvIndex'>
            ...
            <!-- Menu Action Icon -->
            <template if:true={_useActionMenu}>
              <div class="nds-grid nds-dropdown-trigger nds-dropdown-trigger_click nds-is-open nds-col_bump-left nds-m-right_small">
                <button type="button"
                        class="nds-button nds-button_icon-border-filled nds-editblock_action-button nds-element_text-font"
                        aria-haspopup="true"
                        aria-expanded={_menuExpanded}
          ...
          <section role="dialog"
            ...
            <div class="nds-modal__container">
              <header class="nds-modal__header">
                <h1 class="nds-text-heading_small nds-step_label">{_propSetMap.label}</h1>
              </header>
      ...
      <template if:true={_isLongCards}>
        <template if:true={showAdd}>
          <div class="nds-grid nds-grid_align-center nds-m-right_medium nds-m-bottom_medium nds-size_12-of-12 nds-edit-block_cards-add-card nds-edit-block_longcards"
               role="button"
               tabindex="0"
               onclick={handleAdd}
            ...
            <div class="nds-grid nds-cont-wrapper">
              ...
              <div class="nds-edit-block_longcards-add-icon nds-grid nds-has-flexi-truncate nds-align_absolute-center">
                <c-icon class="nds-align_absolute-center"
