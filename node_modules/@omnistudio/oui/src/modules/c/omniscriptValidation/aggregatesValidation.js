...
export const AggregatesValidation = Base => {
    return class extends Base {
        ...
        connectedCallback() {
            ...
            this.template.addEventListener(VALIDATION_EVENTS.VALID, this.markInputAsValid.bind(this));
            this.template.addEventListener(VALIDATION_EVENTS.INVALID, this.markInputAsInvalid.bind(this));
        }
        ...
        markInputAsInvalid(evt) {
            let order = [];
            const ordered = {};
            this.invalidElements = { ...this.invalidElements, ...{ [evt.detail.jsonPath]: evt.target } };

            order = Object.keys(this.invalidElements).sort((a, b) => {
                return this.invalidElements[a]?.getBoundingClientRect().top - this.invalidElements[b]?.getBoundingClientRect().top;
            });
