 ...
 * Build: v234.0.0
 */
import { getElementValue, handleMergeField, isRepeatNotation, getNamespaceDotNotation } from 'c/omniscriptInternalUtils';
...
export function configureRemoteParams(comp) {
    ...
    if (type === 'SObject') {
        ...
        if (
            ...
            const inputParams = jsonDef.propSetMap.dataSource.mapItems.inputParameters;
            const queryCriteria = {};
        ...
        const picklistObjectAndField = jsonDef.propSetMap.dataSource.picklistObjectAndField.split('.');
        ...
        option.picklistRecordType = handleMergeField(
            ...
            jsonData,
            uiElements,
            isRepeatNotation(jsonDef.propSetMap.dataSource.picklistRecordType) ? JSONPath : null,
        );
        input = jsonData;
    }
