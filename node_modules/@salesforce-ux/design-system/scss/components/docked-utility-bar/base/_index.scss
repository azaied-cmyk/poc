...
.slds-utility-bar__item_pop-out {
  ...
  &:before {
    ...
    height: 4px;
    width: 4px;
    border-top: $border-width-thin solid $color-text-default;
    border-right: $border-width-thin solid $color-text-default;
    ...
    @include rtl() {
      ...
      /*! @noflip */
      border-left: $border-width-thin solid $color-text-default;
    }
  }
