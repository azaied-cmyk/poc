...
.slds-popover--walkthrough {
  ...
  .slds-popover__header {
    ...
    text-shadow: 0 0 4px $popover-walkthrough-color-background;
  }
...
.slds-popover_feature {
  ...
  background-image: url($popover-walkthrough-alt-image);
  background-repeat: no-repeat;
  ...
  &.slds-nubbin--bottom-right {
    ...
    &:before {
      background-color: $popover-walkthrough-alt-nubbin-color-background;
    }
  }
}
