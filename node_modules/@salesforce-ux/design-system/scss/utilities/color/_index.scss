...
.slds-color__text_gray-1 {
  color: $color-gray-1 !important; // stylelint-disable declaration-no-important
}
...
.slds-color__background_gray-11 {
  background-color: $color-gray-11 !important;
}
...
.slds-color__background_gray-12 {
  background-color: $color-gray-12 !important;
}
...
.slds-color__border_gray-7 {
  border-color: $color-gray-7 !important;
}
...
.slds-color__border_gray-9 {
  border-color: $color-gray-9 !important;
}
