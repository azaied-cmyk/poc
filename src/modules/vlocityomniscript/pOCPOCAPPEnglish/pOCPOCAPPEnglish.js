...
import { OMNIDEF } from './pOCPOCAPPEnglish_def.js';
import tmpl from './pOCPOCAPPEnglish.html';
import tmpl_nds from './pOCPOCAPPEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class pOCPOCAPPEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
