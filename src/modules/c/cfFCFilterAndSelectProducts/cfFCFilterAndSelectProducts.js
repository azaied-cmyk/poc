import { FlexCardMixin } from "c/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "c/flexCardUtility";
          ...
          export default class cfFCFilterAndSelectProducts extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfFCFilterAndSelectProducts';
