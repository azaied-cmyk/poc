 ...
 */
import VlocApp from 'vlocityomniscript/pOCPOCAPPEnglish';
...
if (isCompatibleBrowser) {
     ...
     */
    if (!customElements.get('vlocityomniscript-poc-pocapp-english')) {
        customElements.define('vlocityomniscript-poc-pocapp-english', VlocApp.CustomElementConstructor);
    }
}
